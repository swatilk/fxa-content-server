...
module.exports = function (req, res, next) {
  ...
  // Explicitly allow robots to fetch pages from the site,
  // if they happen to find inbound links from other pages.
  if (req.path === '/robots.txt') {
    res.type('txt').send('User-agent: *\nAllow:');
    return;
  }

  // Include clear DONT INDEX THIS instructions for every page.
